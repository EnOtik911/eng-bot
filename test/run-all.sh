...
for t in test/fsrs.test.mjs test/session.test.mjs test/auth.test.mjs \
         ...
         test/practice-server.test.mjs test/stats-server.test.mjs test/achievements.test.mjs \
         test/gloss.test.mjs \
         ...
         test/dom-ids.test.mjs test/css-hidden.test.mjs test/theme.test.mjs test/contrast.test.mjs test/css-perf.test.mjs test/decor.test.mjs test/design-system.test.mjs \
